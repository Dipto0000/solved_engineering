...
const phoneDisplay = "+880 1700 000000";
/** Digits only, in international format (no +, no spaces) for tel: / wa.me. */
const phoneRaw = "8801700000000";
...
export const site = {
  ...
  description:
    "Solved Engineering delivers plumbing, painting, flooring, epoxy pointing, electrical, cleaning and full renovation services under one accountable team.",
  ...
  contact: {
    ...
    email: "hello@solvedengineering.com",
    emailHref: "mailto:hello@solvedengineering.com",
    address: "Dhaka, Bangladesh",
    hours: "Sat – Thu · 8:00 AM – 9:00 PM",
  },

  founder: {
    name: "Mahmudul Hasan Roman",
    role: "Founder & CEO",
    initials: "MR",
    quote:
